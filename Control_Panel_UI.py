...
class Ui_Control_Panel_UI(object):
    def setupUi(self, Control_Panel_UI):
        Control_Panel_UI.setObjectName("Control_Panel_UI")
        Control_Panel_UI.resize(1453, 872)
        ...
        Control_Panel_UI.setPalette(palette)
        self.Main_Layout = QtWidgets.QWidget(Control_Panel_UI)
        ...
        self.Evaluation_scrollArea_Widget.setGeometry(QtCore.QRect(0, 0, 880, 1000))
        self.Evaluation_scrollArea_Widget.setObjectName("Evaluation_scrollArea_Widget")
        self.Evaluatio_GridWidget = QtWidgets.QWidget(self.Evaluation_scrollArea_Widget)
        ...
        self.Evaluation_scrollArea_Widget_GridLayout = QtWidgets.QGridLayout(self.Evaluatio_GridWidget)
        self.Evaluation_scrollArea_Widget_GridLayout.setContentsMargins(0, 0, 0, 0)
        self.Evaluation_scrollArea_Widget_GridLayout.setSpacing(26)
        self.Evaluation_scrollArea_Widget_GridLayout.setObjectName("Evaluation_scrollArea_Widget_GridLayout")
        ...
        self.Evaluation_scrollArea_Widget_GridLayout.addLayout(self.Stability_Layout, 1, 2, 1, 1)
        ...
        self.Evaluation_scrollArea_Widget_GridLayout.addLayout(self.Efficiency_Layout, 0, 0, 1, 1)
        ...
        self.Evaluation_scrollArea_Widget_GridLayout.addLayout(self.Overview_Layout, 2, 2, 1, 1)
        ...
        self.Evaluation_scrollArea_Widget_GridLayout.addLayout(self.Conflict_Layout, 1, 0, 1, 1)
        ...
        self.Evaluation_scrollArea_Widget_GridLayout.addLayout(self.Service_Level_Layout, 2, 0, 1, 1)
        ...
        self.Evaluation_scrollArea_Widget_GridLayout.addLayout(self.Safety_Layout, 0, 2, 1, 1)
        ...
        self.Main_Lane_Triffic_Scrollbar = QtWidgets.QScrollBar(self.Main_Layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(4)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Main_Lane_Triffic_Scrollbar.sizePolicy().hasHeightForWidth())
        ...
        self.Main_Lane_Triffic_Scrollbar.setObjectName("Main_Lane_Triffic_Scrollbar")
        self.Main_Lane_Triffic_Layout.addWidget(self.Main_Lane_Triffic_Scrollbar)
        self.Main_Lane_Triffic_LineEdit = QtWidgets.QLineEdit(self.Main_Layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Main_Lane_Triffic_LineEdit.sizePolicy().hasHeightForWidth())
        self.Main_Lane_Triffic_LineEdit.setSizePolicy(sizePolicy)
        self.Main_Lane_Triffic_LineEdit.setStyleSheet("color:white;\n"
"background-color:rgb(70 , 70 , 70);\n"
"border: 1px solid rgb(28 , 28 , 28);")
        self.Main_Lane_Triffic_LineEdit.setObjectName("Main_Lane_Triffic_LineEdit")
        self.Main_Lane_Triffic_Layout.addWidget(self.Main_Lane_Triffic_LineEdit)
        ...
        self.Ramp_Lane_Triffic_Scrollbar = QtWidgets.QScrollBar(self.Main_Layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(4)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Ramp_Lane_Triffic_Scrollbar.sizePolicy().hasHeightForWidth())
        ...
        self.Ramp_Lane_Triffic_Scrollbar.setObjectName("Ramp_Lane_Triffic_Scrollbar")
        self.Ramp_Lane_Triffic_Layout.addWidget(self.Ramp_Lane_Triffic_Scrollbar)
        self.Ramp_Lane_Triffic_LineEdit = QtWidgets.QLineEdit(self.Main_Layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Ramp_Lane_Triffic_LineEdit.sizePolicy().hasHeightForWidth())
        self.Ramp_Lane_Triffic_LineEdit.setSizePolicy(sizePolicy)
        self.Ramp_Lane_Triffic_LineEdit.setStyleSheet("color:white;\n"
"background-color:rgb(70 , 70 , 70);\n"
"border: 1px solid rgb(28 , 28 , 28);")
        self.Ramp_Lane_Triffic_LineEdit.setObjectName("Ramp_Lane_Triffic_LineEdit")
        self.Ramp_Lane_Triffic_Layout.addWidget(self.Ramp_Lane_Triffic_LineEdit)
        ...
        self.Truck_Mixing_Rate_Scrollbar = QtWidgets.QScrollBar(self.Main_Layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(4)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Truck_Mixing_Rate_Scrollbar.sizePolicy().hasHeightForWidth())
        ...
        self.Truck_Mixing_Rate_Scrollbar.setObjectName("Truck_Mixing_Rate_Scrollbar")
        self.Truck_Mixing_Rate_Layout.addWidget(self.Truck_Mixing_Rate_Scrollbar)
        self.Truck_Mixing_Rate_LineEdit = QtWidgets.QLineEdit(self.Main_Layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Truck_Mixing_Rate_LineEdit.sizePolicy().hasHeightForWidth())
        self.Truck_Mixing_Rate_LineEdit.setSizePolicy(sizePolicy)
        self.Truck_Mixing_Rate_LineEdit.setStyleSheet("color:white;\n"
"background-color:rgb(70 , 70 , 70);\n"
"border: 1px solid rgb(28 , 28 , 28);")
        self.Truck_Mixing_Rate_LineEdit.setObjectName("Truck_Mixing_Rate_LineEdit")
        self.Truck_Mixing_Rate_Layout.addWidget(self.Truck_Mixing_Rate_LineEdit)
        ...
        sizePolicy.setHorizontalStretch(4)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Speed_Setting_Scrollbar.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Speed_Setting_LineEdit.sizePolicy().hasHeightForWidth())
        self.Speed_Setting_LineEdit.setSizePolicy(sizePolicy)
        self.Speed_Setting_LineEdit.setStyleSheet("color:white;\n"
"background-color:rgb(70 , 70 , 70);\n"
"border: 1px solid rgb(28 , 28 , 28);")
        ...
        self.Auto_Driving_Rate_Scrollbar = QtWidgets.QScrollBar(self.Main_Layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(4)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Auto_Driving_Rate_Scrollbar.sizePolicy().hasHeightForWidth())
        ...
        self.Auto_Driving_Rate_Scrollbar.setObjectName("Auto_Driving_Rate_Scrollbar")
        self.Auto_Driving_Rate_Layout.addWidget(self.Auto_Driving_Rate_Scrollbar)
        self.Auto_Driving_Rate_LineEdit = QtWidgets.QLineEdit(self.Main_Layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Auto_Driving_Rate_LineEdit.sizePolicy().hasHeightForWidth())
        self.Auto_Driving_Rate_LineEdit.setSizePolicy(sizePolicy)
        self.Auto_Driving_Rate_LineEdit.setStyleSheet("color:white;\n"
"background-color:rgb(70 , 70 , 70);\n"
"border: 1px solid rgb(28 , 28 , 28);")
        self.Auto_Driving_Rate_LineEdit.setObjectName("Auto_Driving_Rate_LineEdit")
        self.Auto_Driving_Rate_Layout.addWidget(self.Auto_Driving_Rate_LineEdit)
        ...
        self.Simulation_Stride_Scrollbar = QtWidgets.QScrollBar(self.Main_Layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(4)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Simulation_Stride_Scrollbar.sizePolicy().hasHeightForWidth())
        ...
        self.Simulation_Stride_Scrollbar.setObjectName("Simulation_Stride_Scrollbar")
        self.Simulation_Stride_Layout.addWidget(self.Simulation_Stride_Scrollbar)
        self.Simulation_Stride_LineEdit = QtWidgets.QLineEdit(self.Main_Layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Simulation_Stride_LineEdit.sizePolicy().hasHeightForWidth())
        self.Simulation_Stride_LineEdit.setSizePolicy(sizePolicy)
        self.Simulation_Stride_LineEdit.setStyleSheet("color:white;\n"
"background-color:rgb(70 , 70 , 70);\n"
"border: 1px solid rgb(28 , 28 , 28);")
        self.Simulation_Stride_LineEdit.setObjectName("Simulation_Stride_LineEdit")
        self.Simulation_Stride_Layout.addWidget(self.Simulation_Stride_LineEdit)
        ...
        self.Lane_Change_Model_RadioB = QtWidgets.QRadioButton(self.Main_Layout)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.New_Simulation_Button.sizePolicy().hasHeightForWidth())
        self.New_Simulation_Button.setSizePolicy(sizePolicy)
        self.New_Simulation_Button.setMinimumSize(QtCore.QSize(0, 25))
        self.New_Simulation_Button.setStyleSheet("QPushButton{\n"
"color:white;\n"
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Pause_Simulation_Button.sizePolicy().hasHeightForWidth())
        self.Pause_Simulation_Button.setSizePolicy(sizePolicy)
        self.Pause_Simulation_Button.setMinimumSize(QtCore.QSize(0, 25))
        self.Pause_Simulation_Button.setStyleSheet("QPushButton{\n"
"color:white;\n"
"background-color:rgb(65 , 65 , 65);\n"
"border: 1px solid rgb(28 , 28 , 28);\n"
"}\n"
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.End_Simulation_Button.sizePolicy().hasHeightForWidth())
        self.End_Simulation_Button.setSizePolicy(sizePolicy)
        self.End_Simulation_Button.setMinimumSize(QtCore.QSize(0, 25))
        self.End_Simulation_Button.setStyleSheet("QPushButton{\n"
"color:white;\n"
"background-color:rgb(65 , 65 , 65);\n"
"border: 1px solid rgb(28 , 28 , 28);\n"
"}\n"
...
"}")
        ...
        spacerItem22 = QtWidgets.QSpacerItem(0, 0, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        Control_Panel_UI.setCentralWidget(self.Main_Layout)

        self.retranslateUi(Control_Panel_UI)
        QtCore.QMetaObject.connectSlotsByName(Control_Panel_UI)

    def retranslateUi(self, Control_Panel_UI):
        _translate = QtCore.QCoreApplication.translate
        Control_Panel_UI.setWindowTitle(_translate("Control_Panel_UI", "控制面板"))
        self.label_3.setText(_translate("Control_Panel_UI", "稳定性评价"))
        self.label_5.setText(_translate("Control_Panel_UI", "效率评价"))
        self.label_11.setText(_translate("Control_Panel_UI", "综合评价"))
        self.label_7.setText(_translate("Control_Panel_UI", "冲突评价"))
        self.label_9.setText(_translate("Control_Panel_UI", "服务水平"))
        self.label.setText(_translate("Control_Panel_UI", "安全评价"))
        self.Main_Lane_Triffic_Lable.setText(_translate("Control_Panel_UI", "主线交通量  "))
        self.Main_Lane_Triffic_LineEdit.setText(_translate("Control_Panel_UI", "0"))
        self.Ramp_Lane_Triffic_Lable.setText(_translate("Control_Panel_UI", "匝道交通量  "))
        self.Ramp_Lane_Triffic_LineEdit.setText(_translate("Control_Panel_UI", "0"))
        self.Truck_Mixing_Rate_Lable.setText(_translate("Control_Panel_UI", "大车混入率  "))
        self.Truck_Mixing_Rate_LineEdit.setText(_translate("Control_Panel_UI", "0"))
        self.Speed_Setting_Lable.setText(_translate("Control_Panel_UI", "速度设定    "))
        self.Speed_Setting_LineEdit.setText(_translate("Control_Panel_UI", "0"))
        self.Auto_Driving_Rate_Lable.setText(_translate("Control_Panel_UI", "自动驾驶比率"))
        self.Auto_Driving_Rate_LineEdit.setText(_translate("Control_Panel_UI", "0"))
        self.Simulation_Stride_Lable.setText(_translate("Control_Panel_UI", "仿真步长    "))
        self.Simulation_Stride_LineEdit.setText(_translate("Control_Panel_UI", "1"))
        self.Following_Model_RadioB.setText(_translate("Control_Panel_UI", "跟驰模型"))
        self.Lane_Change_Model_RadioB.setText(_translate("Control_Panel_UI", "换道模型"))
        self.New_Simulation_Button.setText(_translate("Control_Panel_UI", "开始新的仿真"))
        self.Pause_Simulation_Button.setText(_translate("Control_Panel_UI", "暂停仿真"))
        self.End_Simulation_Button.setText(_translate("Control_Panel_UI", "结束仿真"))
        self.Export_Data_Button.setText(_translate("Control_Panel_UI", "导出数据"))
