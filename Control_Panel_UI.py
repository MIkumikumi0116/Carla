...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Main_Lane_Triffic_Lable.setText(_translate("MainWindow", "主线交通量  "))
        self.Main_Lane_Triffic_LineEdit.setText(_translate("MainWindow", "0"))
        self.Ramp_Lane_Triffic_Lable.setText(_translate("MainWindow", "匝道交通量  "))
        self.Ramp_Lane_Triffic_LineEdit.setText(_translate("MainWindow", "0"))
        self.Truck_Mixing_Rate_Lable.setText(_translate("MainWindow", "大车混入率  "))
        ...
        self.Auto_Driving_Rate_Lable.setText(_translate("MainWindow", "自动驾驶比率"))
        self.Auto_Driving_Rate_LineEdit.setText(_translate("MainWindow", "0"))
        self.Simulation_Stride_Lable.setText(_translate("MainWindow", "仿真步长    "))
